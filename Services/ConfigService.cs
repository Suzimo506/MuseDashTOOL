...
public class ConfigService : IConfigService
{
    ...
    public ConfigService()
    {
        ...
        // 初始化默认配置的版本号
        Config.LastRunVersion = typeof(AppConfig).Assembly.GetName().Version?.ToString() ?? "1.4.9";
    }
    ...
    private static void NormalizeLegacyConfig(AppConfig config)
    {
        ...
        // 版本更新时重置教程弹窗
        var currentVersion = typeof(AppConfig).Assembly.GetName().Version?.ToString() ?? "1.4.9";
