...
- 📦 **模组管理**：支持一键导入、启用/禁用、批量删除、在线模组市场与联机模组依赖下载。
- 🎵 **谱面管理**：支持快速下载、试听 MDMC 社区谱面；支持试听、点赞、下载 Euterpe 社区谱面；并整合 QQ 群谱面与国内谱师曲包。
- 🔎 **全局搜索**：同时检索 MDMC、Euterpe 与 QQ 群谱面，快速定位想玩的谱面。
- 📁 **谱面分组**：支持自由创建与管理谱面分组，实现多维度的谱面整理，并可将新谱默认下载到候选区。
- 🌐 **联机大厅**：查看 Ensemble 联机节点与房间状态，浏览房间成员、观众聊天与游戏内回应，并可跳转下载联机模组。
- 🔧 **配置编辑**：内置直观的模组配置文件编辑器，无需手动翻找 JSON/cfg。
- 🌍 **智能翻译**：自动调用在线翻译服务，轻松阅读外语模组描述。
- 🎨 **个性化**：支持自定义背景图片、模糊度、字体以及主题色调。
- 🌐 **多语言支持**：原生支持中文与英文界面，可在设置中无缝切换。
