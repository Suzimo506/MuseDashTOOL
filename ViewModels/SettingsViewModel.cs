...
public partial class SettingsViewModel : ObservableObject
{
    ...
    // 是否显示右侧面板文字颜色输入框
    [ObservableProperty]
    private bool _isRightPanelColorInputVisible = false;

    // 是否显示主题颜色输入框
    [ObservableProperty]
    private bool _isThemeColorInputVisible = false;
    ...
    {
        string message = MdModManager.Services.I18nService.Instance["Str_405"] ?? "是否开始一键安装自制谱？";
    ...
    // 切换自定义文字颜色输入框显示状态
    [RelayCommand]
    private void ToggleCustomThemeColorInput() => IsCustomColorInputVisible = !IsCustomColorInputVisible;

    // 切换右侧面板文字颜色输入框显示状态
    [RelayCommand]
    private void ToggleRightPanelColorInput() => IsRightPanelColorInputVisible = !IsRightPanelColorInputVisible;

    // 切换主题颜色输入框显示状态
    [RelayCommand]
    private void ToggleThemeColorInput() => IsThemeColorInputVisible = !IsThemeColorInputVisible;
